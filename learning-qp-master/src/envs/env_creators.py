...
sys_param = {
    ...
    "cartpole": {
        ...
        "states_min": np.array([[-2.2], [-1000], [-1], [-1000]]),
        "states_max": np.array([[2.2], [1000], [1], [1000]]),
        "states_safe_min":np.array([[-2], [-1000], [-0.5], [-1000]]),
        "states_safe_max": np.array([[2], [1000], [0.5], [1000]]),
        "u_min": -10,
        "u_max": 10,
        "dt": 0.1,
    },
...
env_creators = {
    "double_integrator": lambda **kwargs: LinearSystem(
        ...
        x_safe_min=sys_param["double_integrator"]["x_safe_min"] * np.ones(2),
        x_safe_max=sys_param["double_integrator"]["x_safe_max"] * np.ones(2),
